        ...
        const promises = urls.map((url) => {
            return new Promise((resolve, reject) => {
                ...
                image.onerror = () => {
                    resolve(image);
                    // fallback texture
                    image.src = `data:image/png;base64,`;
                }
            });
        });
