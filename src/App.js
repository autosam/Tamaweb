...
export const App = {
  ...
  async init() {
    ...
    if (navigator?.userAgent == "electron-client")
      App.isOnElectronClient = true;
  ...
  unregisterOnDrawEvent: function (inp) {
    let index =
      typeof inp === "function" ? this.registeredDrawEvents.indexOf(inp) : inp;
  ...
  addRecord: function (name, newValue, shouldReplaceValue) {
    ...
    this.records[name] = shouldReplaceValue
      ? newValue
