...
export const Missions = {
  ...
  openRewardsMenu: function () {
    ...
    const foodPool = Object.keys(defs.food)
      .filter((key) => defs.food[key].price)
      .map((key) => {
        return {
          name: key,
    ...
    const chests = [
      ...
      },
      {
        ...
        info: `
                ...
                `,
        onClaim: () => {
          const pool = [...foodPool, ...itemsPool, ...accessoriesPool];
      ...
      [
        ...
        ...chests.map((chest) => {
          return {
            ...
            onclick: () => {
              App.displayConfirm(
                `Open the <br> <b>${chest.name}</b> <br> for <br> ${App.getIcon("coins") + chest.price}?`,
                [
                  {
                    name: `yes`,
                    onclick: () => {
                      ...
                      document.querySelector("#mission-pts").textContent =
                        Missions.currentPts;
                      list.close();
            ...
            return {
              ...
              onclick: (btn) => {
                ...
                if (Missions.currentStep < Missions.MAX_STEPS) {
                  ...
                  Missions.currentStep++;
                  list.querySelector("#mission-pts").textContent =
                    Missions.currentPts;
