...
export class Drawer {
  ...
  draw(objects, skipClear) {
    ...
    objects.forEach((object) => {
      ...
      if (object.onDraw !== undefined) object.onDraw(object);
      ...
      function drawSprite(object, x, y, context) {
        ...
        const spriteCenterX =
          x +
          (spritesheet ? spritesheet.cellSize / 2 : (width || image.width) / 2);
        const spriteCenterY =
          y +
          (spritesheet
      ...
      if (object.dirtyPatches) {
        ...
        areas.forEach((area) => {
          ...
          this.context.arc(
            x + area[0],
            y + object.upperHalfOffsetY + area[1],
            area[2],
            0,
            2 * Math.PI,
            false,
      ...
      if (object.onLateDraw !== undefined) object.onLateDraw();
    });
    return this;
  }
  pixelate() {
