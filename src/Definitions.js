...
export const Definitions = {
    ...
    secretary: {
      ...
      createFn: function (parent) {
        ...
        const handleArrows = (me, i) => {
          ...
          const offsetMult = 10,
            strength = 0.8 + -secretary.movementMult * 0.25;
          switch (i) {
            case 0:
              localPosition.x = -spread;
              localPosition.y = -spread;
              me.inverted = true;
              localPosition.x +=
                Math.sin(secretary.animationFloat - i * offsetMult) * strength;
              localPosition.y +=
                Math.sin(secretary.animationFloat - i * offsetMult) * strength;
              break;
            case 1:
        ...
        new Object2d({
          ...
          onDraw: (me) => {
            ...
            me.y = me.parent.y;
            me.rotation =
              Math.sin(secretary.bodyAnimationFloat) *
              45 *
              secretary.movementMult;
          },
          // composite: "darken"
        });
    ...
    cloof: {
      ...
      createFn: function (parent) {
        ...
        const cloof = new Object2d({
          ...
          onDraw: (me) => {
            me.animationFloatX =
              (me.animationFloatX + 0.0035 * App.deltaTime) % App.PI2;
            me.animationFloatY =
              (me.animationFloatY + 0.0025 * App.deltaTime) % App.PI2;
  ...
  achievements: {
    ...
    redecor_x_times: {
      ...
      advance: (amount) =>
        App.addRecord("times_redecorated_background", amount),
      getReward: () => {
    ...
    perfect_minigame_rodrush_win_x_times: {
      ...
      checkProgress: () =>
        App.getRecord("times_perfected_rodrush_minigame") >= 10,
      advance: (amount) =>
        App.addRecord("times_perfected_rodrush_minigame", amount),
      getReward: () => {
        App.pet.stats.gold += 500;
        App.displayPopup(`You've received $500!`);
      },
    ...
    perfect_minigame_mimic_win_x_times: {
      ...
      checkProgress: () =>
        App.getRecord("times_perfected_mimic_minigame") >= 10,
      advance: (amount) =>
        App.addRecord("times_perfected_mimic_minigame", amount),
      getReward: () => {
        App.pet.stats.gold += 500;
        App.displayPopup(`You've received $500!`);
      },
  ...
  tweets: {
    generic: [
      [
        "Found a crumb, feels like a feast! #TinyTreats",
        1,
      ...
      [
        "Nap in a matchbox bed. So cozy! #SmallDreams",
        16,
      ...
      [
        "Tried lifting a pebble, felt strong! #TinyStrength",
        1,
        "resources/img/background/outside/park_02.png",
      ],
      [
        "Stargazing tonight. Wishes everywhere! #StarrySky",
        1,
        "resources/img/background/sky/night.png",
      ],
      [
        "A butterfly landed on me! #ButterflyFriends",
        2,
        "resources/img/background/outside/garden_01.png",
      ],
      ["Dewdrop crystal ball. Big adventures ahead! #DewdropVisions", 7, null],
      [
        "Lost in a grass maze. Tall blades everywhere! #GrassAdventures",
        1,
        "resources/img/background/outside/garden_01.png",
      ],
      [
        "Shared a berry with an ant. #BerryFeast",
        8,
        "resources/img/background/outside/garden_01.png",
      ],
      ...
      [
        "Played hide and seek with parents! #TinyGames",
        2,
        "resources/img/background/house/parents_house_01.png",
      ],
      [
        "Leaf fell on me. Guess I’m a tree now! #TreeLife",
        8,
        "resources/img/background/outside/park_02.png",
      ],
      ...
      [
        "Prices too high! #whatisthis",
        7,
        "resources/img/background/outside/market_01.png",
      ],
      [
        "Looking for a cute #headband!",
        8,
        "resources/img/background/outside/market_01.png",
      ],
      [
        "Lost again! Done with gaming. #hategaming",
        6,
        "resources/img/background/house/arcade_01.png",
      ],
      [
        "I’m just better! #gaming",
        2,
        "resources/img/background/house/arcade_01.png",
      ],
      [
        "Won again! #ilovegaming",
        2,
        "resources/img/background/house/arcade_01.png",
      ],
      [
        "Chasing rainbows today! #ColorChase",
        1,
        "resources/img/background/outside/garden_01.png",
      ],
      ["Found a ladybug! So lucky. #LuckyDay", 2, null],
      [
        "Tiny picnic in the grass. Life is good! #TinyPicnic",
        8,
        "resources/img/background/outside/park_02.png",
      ],
      [
        "Jumping puddles! Let’s get wet. #PuddleJump",
        10,
        "resources/img/background/sky/rain_01.png",
      ],
      [
        "The sky’s full of clouds. So dreamy. #CloudyDay",
        1,
        "resources/img/background/sky/afternoon.png",
      ],
      [
        "Met a squirrel today. Best friends now! #SquirrelSquad",
        7,
        "resources/img/background/outside/park_02.png",
      ],
      [
      ...
      [
        "I’m a leaf warrior! #LeafBattle",
        1,
        "resources/img/background/outside/park_02.png",
      ],
      [
        "Discovered a secret path in the woods. #MysteryTrail",
        7,
        "resources/img/background/outside/park_02.png",
      ],
      [
        "Feeling like a cloud. Soft and fluffy. #CloudVibes",
        8,
        "resources/img/background/sky/afternoon.png",
      ],
    ],
