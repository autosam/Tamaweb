...
export const lerp = function (s, e, p) {
  return (1 - p) * s + p * e;
};
export const clamp = function (n, min, max) {
  if (n < min) n = min;
  if (n > max) n = max;
  return n;
};
export const random = function (min, max, seeded) {
  if (seeded) {
    pRandom.save();
    pRandom.seed = seeded;
...
export const move = function (s, e, amount) {
  if (s > e) {
    s -= amount;
    if (s < e) s = e;
  } else if (s < e) {
...
export const randomFromArray = function (arr) {
  return arr[random(0, arr.length - 1)];
};
export const pRandomFromArray = function (arr) {
  return arr[pRandom.getIntBetween(0, arr.length - 1)];
};
export const ellipsis = (str, length = 15) => {
...
export function getRandomName(seed) {
  const firstNames = [
    "Aaren",
    "Aarika",
    "Abagael",
